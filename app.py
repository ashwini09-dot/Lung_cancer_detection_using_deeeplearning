...
def load_model():
    ...
    if not os.path.exists(model_path):
        with st.spinner('Downloading model... This may take a minute...'):
            ...
            model_url = 'YOUR_GOOGLE_DRIVE_LINK_HERE'  # Replace this with your actual link
            
            # For Google Drive links, use gdown
...
with st.expander("About this app"):
    st.write("""
    This application uses an EfficientNetB1 model trained on biopsy images to detect lung cancer.
    The model can identify three classes:
    - No Cancer
    - Adenocarcinoma
    - Squamous Cell Carcinoma
    
    The heatmap visualization highlights the areas of the image that most influenced the model's prediction.
    """)
